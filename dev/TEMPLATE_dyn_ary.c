...
)
{
    ...
    {
        TEMPLATE_datatype_move(dyn_ary->data + i, dyn_ary->data + i - 1);
        // memcpy(
    ...
    TEMPLATE_datatype_move(dyn_ary->data + index, to_insert);
    // memcpy(
...
)
{
    ...
    TEMPLATE_datatype_move(removed_elem, dyn_ary->data + idx);
    // memcpy(
    //     removed_elem,

...
#define RB_TREE_HANDLE_RED_VIOLATION_FNNAME \
  COLN_CAT(RB_TREE, _handle_red_violation)
...
#define RB_NODE_ROTATE_FROM_LR_SIGN \
  static void RB_NODE_ROTATE_FROM_LR(RB_NODE_TYPENAME **accessor)
...
#define RB_NODE_ROTATE_FROM_RL_SIGN \
  static void RB_NODE_ROTATE_FROM_RL(RB_NODE_TYPENAME **accessor) 
...
#undef RB_TREE__PRIV__HANDLE_BLACK_VIOLATION_DEFN
#undef RB_TREE__PRIV__HANDLE_BLACK_VIOLATION_DECL
#undef RB_TREE__PRIV__HANDLE_BLACK_VIOLATION
#undef RB_TREE__PRIV__HANDLE_RED_VIOLATION_DEFN
#undef RB_TREE__PRIV__HANDLE_RED_VIOLATION_DECL
#undef RB_TREE__PRIV__HANDLE_RED_VIOLATION
#undef RB_NODE_ROTATE_FROM_RL_DEFN
#undef RB_NODE_ROTATE_FROM_RL_DECL
#undef RB_NODE_ROTATE_FROM_RL
#undef RB_NODE_ROTATE_FROM_LR_DEFN
#undef RB_NODE_ROTATE_FROM_LR_DECL
#undef RB_NODE_ROTATE_FROM_LR
#undef RB_NODE_ROTATE_FROM_LL_DEFN
#undef RB_NODE_ROTATE_FROM_LL_DECL
#undef RB_NODE_ROTATE_FROM_LL
#undef RB_NODE__PRIV__ROTATE_FROM_RR_DEFN
#undef RB_NODE__PRIV__ROTATE_FROM_RR_DECL
#undef RB_NODE__PRIV__ROTATE_FROM_RR
#undef RB_NODE__PRIV__ROTATE_DEFN
#undef RB_NODE__PRIV__ROTATE_DECL
#undef RB_NODE__PRIV__ROTATE
#undef RB_NODE__PRIV__COPY_DEFN
#undef RB_NODE__PRIV__COPY_DECL
#undef RB_NODE__PRIV__COPY_INVOC
#undef RB_NODE__PRIV__COPY
#undef RB_NODE__PRIV__DESTROY_DEFN
#undef RB_NODE__PRIV__DESTROY_DECL
#undef RB_NODE__PRIV__DESTROY_INVOC
#undef RB_NODE__PRIV__DESTROY
